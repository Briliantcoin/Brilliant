...
// File contracts/flatten/Erc20Token.sol
...
// File @openzeppelin/contracts/token/ERC20/ERC20Capped.sol@v3.4.1
...
abstract contract ERC20PresetPauserCapped is
    Context,
    AccessControl,
    ERC20Burnable,
    ERC20Pausable,
...
contract ERC20Token is ERC20PresetPauserCapped, Ownable {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        uint256 supplyCap,
        address minter
    ) ERC20PresetPauserCapped(name, symbol, supplyCap, minter) {
